...
(function($){
    ...
    $.fn.tagEditorInput=function(){var t=" ",e=$(this),n=parseInt(e.css("fontSize")),i=$("<span/>").css({position:"absolute",top:"-9999px",left:"-9999px",width:"auto",fontSize:e.css("fontSize"),fontFamily:e.css("fontFamily"),fontWeight:e.css("fontWeight"),letterSpacing:e.css("letterSpacing"),whiteSpace:"nowrap"}),s=function(){if(t!==(t=e.val())){i.text(t);var s=i.width()+n;20>s&&(s=20),s!=e.width()&&e.width(s)}};return i.insertAfter(e),e.bind("keyup keydown focus",s)};
    ...
    $.fn.tagEditor = function(options, val, blur){
        ...
        return selector.each(function(){
            ...
            ed.on('keydown', 'input', function(e){
                ...
                // enter key
                else if (e.which == 13 || e.which == 32 || e.which == 188) {
