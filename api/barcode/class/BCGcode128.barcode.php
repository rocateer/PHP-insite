 ...
 *--------------------------------------------------------------------
 * Revision History
 * v2.1.0	8  nov	2009	Jean-S?astien Goupil	Specify exact table for encoding
 * v2.0.1	8  mar	2009	Jean-S?astien Goupil	Fix Code 128 C
 * v2.00	23 apr	2008	Jean-S?astien Goupil	New Version Update
 * v1.2.3pl2	27 sep	2006	Jean-S?astien Goupil	There were some errors dealing with C table
 * v1.2.3b	30 dec	2005	Jean-S?astien Goupil	Checksum separated + PHP5.1 compatible
 * v1.2.1	27 jun	2005	Jean-S?astien Goupil	Font support added + Correct bug if passing C to another code
