      ...
      <form name="form_default" id="form_default" method="post">
        <table class="table table-bordered td_left">
          ...
          <tbody>
            ...
            <tr>
              <th style="height:200px;"><span class="text-danger">* </span>
                대표 이미지(1장)<br />(650x560)<br />
...
<script>
  ...
  function default_reg(){
    ...
    // var form_data = {
    //   "title" : $("#title").val(),
    //   "img_path" : $("input[name='img_path[]']:checked").val(),
    ...
    $.ajax({
      ...
      success: function(result){
        ...
        if(result.code == 0) {
          ...
          alert("등록 되었습니다.");
          location.href ='/<?=mapping('community')?>/community_list';
        }
      }
    });
  }
