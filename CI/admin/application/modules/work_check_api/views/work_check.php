...
.project_state select{font-size: 16px;width:135px; height: 30px; padding-left:10px; vertical-align: middle; float:left;}
...
<?php if($_SERVER['REMOTE_ADDR'] ==$_SERVER['REMOTE_ADDR'] || $_SERVER['REMOTE_ADDR'] =='211.118.222.134' ||  $_SERVER['REMOTE_ADDR'] =='222.233.62.100' && $this->uri->uri_string() !="work_check/work_check_list"){ ?>
  ...
  $.ajax({
    ...
    success: function(dom){
      ...
      for (var i = 0; i < dom.length; i++) {
        ...
        html +="<li style='list-style:none;border-bottom:1px solid #ddd;padding:7px 0;margin:4px 0 10px 0;font-size: 12px;'>"+dom[i].memo.replace(/\n/g, "<br />"); + "</li>";
        html +="</br>";
      }
