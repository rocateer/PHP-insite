    ...
    <div class="table-responsive">
      <form name="form_default" id="form_default">
        <table class="search_table">
          ...
          <tbody>
            <tr>
              <th style="text-align:center">운동명</th>
              <td>
                <input class="form-control" name="title" id="title">
              </td>
              <th style="text-align:center">운동 시간</th>
              <td>
...
<script language="javascript">
  ...
  var default_list_get = function(page_num) {
    ...
    $.ajax({
      url: "/<?=mapping('exercise')?>/exercise_list_get",
      type: 'POST',
      dataType : 'html',
      async: true,
      data: form_data,
  ...
  // 상태 수정
  function exercise_state_mod_up(exercise_idx, display_yn){
    ...
    $.ajax({
      url      : "/<?=mapping('exercise')?>/exercise_state_mod_up",
      type     : 'POST',
      dataType : 'json',
      async    : true,
      data     : formData,
