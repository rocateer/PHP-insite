...
define("CERTIFICATIONS_INFO","https://api.iamport.kr/certifications/");//sms인증 URL
define("PAYMENT_CANCEL","https://api.iamport.kr/payments/cancel");//취소 URL
define("IMP_CORP_CODE","imp37942339");//가맹점 식별코드
define("IMP_KEY","0553062779288763");//REST API key
define("IMP_SECRET","PiLZWQy0m4loKD6sAjiu4ZQoLOSYcdY1vJ1rAzsXENlorsQ1M8wQ8mfTa8SnlQoQApibZL8Dyu1ZWS1I");//REST API secret key
