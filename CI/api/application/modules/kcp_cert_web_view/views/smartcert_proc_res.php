<?
    ...
    require "./kcp_lib/ct_cli_lib.php";
    ...
    $home_dir      = "/home/kcpcert_enc"; // ct_cll 절대경로 ( bin 전까지 )
    ...
    if( $cert_enc_use == "Y" )
    {
        if( $res_cd == "0000" )
        {
            ...
            $user_name = iconv("euc-kr","UTF-8",$ct_cert->mf_get_key_value("user_name"));
            ...
            // echo "복호화 이름            :" . iconv("euc-kr","UTF-8",$ct_cert->mf_get_key_value("user_name"))."<br>"; // 이름
            ...
            // echo "복호화 결과메시지      :" . iconv("euc-kr","UTF-8",$ct_cert->mf_get_key_value("res_msg"))."<br>"; // 암호화된 결과메시지
            //
            // $valParam = iconv("euc-kr","UTF-8", $valParam);
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    ...
    <body>
        <form name="form_auth" method="post" accept-charset="UTF-8">
            <?= $sbParam ?>
        </form>
        ...
        function member_info() {
          ...
          var sex_code  ="<?=$sex_code?>";
          var mobile_agent = "<?=$mobile_agent?>";



          if(mobile_agent == 'android') {

            window.rocateer.auth(user_name, phone_no, sex_code, birth_day);

          } else if(mobile_agent == 'ios') {
