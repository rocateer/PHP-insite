<header>
  <div class="btn_close" onclick="modal_close('category');">
  ...
  <div class="">
    ...
    <div class="tab_area_wrap">
      ...
      <div class="">
          ...
          <div class="swiper-container best_swiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <a href="/<?= mapping('main') ?>/main_detail">
                  <div class="i_lank">1</div>
        ...
        <ul class="community_filter_ul">
          <li>
            <input type="radio" name="rdo_1" id="rdo_1_1" checked>
            <label for="rdo_1_1">전체</label>
          </li>
          <li>
            <input type="radio" name="rdo_1" id="rdo_1_2">
            <label for="rdo_1_2">고민상담</label>
          </li>
          <li>
            <input type="radio" name="rdo_1" id="rdo_1_2">
            <label for="rdo_1_2">고민상담</label>
