...
<hr class="space">
<ul class="tab_2">
  <li><a href="/<?=mapping('my_community')?>/my_trade_list">게시글</a></li>
  <li class="active"><a href="/<?=mapping('my_community')?>/my_trade_cnt_list">댓글</a></li>
</ul>
...
<ul class="community_list" id="list_ajax">
  <?php for ($i=0; $i < 6; $i++) {?>
  <li>
    <p class="date">2023.02.01 10:00 <span class="f_right"><img src="/images/ic_more.png" class="w_16" onclick="modal_open_slide('more')"></span></p>
