...
<div class="body">
    <ul class="tab_2">
        <li class="active"><a href="/<?=mapping('my_order')?>/order_product_list">공동구매</a></li>
        <li><a href="/<?=mapping('my_order')?>/order_edu_list">교육</a></li>
    </ul>
    <ul class="product_list">
        ...
        <li>
            <a href="/<?=mapping('my_order')?>/order_product_detail">
                <div class="img_box relative">
                    <img src="/p_images/s4.jpg">
                </div>
                <div class="product_list_body">
                <p class="product_list_title">'봄의 향' 심신안정 방향효과 인센스스틱</p>
                <div class="product_list_item">
                    공동구매 신청 금액 <b class="font_gray_f">75,000원</b>
                    <span class="txt_red f_right">신청 취소</span>
                </div>
                </div>
            </a>
        </li>
        <li>
            <a href="/<?=mapping('my_order')?>/order_product_detail">
                ...
                <div class="product_list_item">
                    공동구매 신청 금액 <b class="font_gray_f">75,000원</b>
                    <span class="font_gray_A0 f_right">취소 완료</span>
                </div>
                </div>
            </a>
        </li>
        <li>
            <a href="/<?=mapping('my_order')?>/product_order_detail">
                ...
                <div class="product_list_item">
                    공동구매 신청 금액 <b class="font_gray_f">75,000원</b>
                    <span class="point_color f_right">발송 완료</span>
                </div>
                </div>
            </a>
        </li>
