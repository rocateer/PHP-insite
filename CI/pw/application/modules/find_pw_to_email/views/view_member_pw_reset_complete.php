...
<body class="pw_bg">
    <div class="centered">
      ...
      <div style="text-align:center; padding-top:50px;">
          ...
          <span style="font-size:20px; font-weight:bold;"> 비밀번호 변경</span>이<br> 완료 되었습니다.
          <p style="font-size:12px; color:#666; padding-top:20px;">변경된 비밀번호를 이용하여 <?=SERVICE_NAME?> 서비스를 이용해 주세요.</p>
