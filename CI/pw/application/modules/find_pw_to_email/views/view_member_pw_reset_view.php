...
<style>
  ...
  .btn {
    ...
    border: 1px solid transparent; white-space:nowrap; padding: 10px 0; width:100%; font-size:17px; line-height: 1.42857143; border-radius:3px; background:#4C35CA; color:#fff;
    font-weight: bold;
    margin-top: 10px;
