		...
		function paging($totalCnt,$pageSize,$pageNum,$fn=""){
			...
			if($totalCnt>0){
				...
				if($block>1){
					$page_html.="
						 <li class='prev'>
						 <a href=javascript:".$fn."(1);> <img src='/images/i_double_prev.png' alt=''> </a>
						 </li>
					...
					$page_html.="
						 <li class='btn_prev'>
						 <a href='#".$pageNum."'> <img src='/images/i_double_prev.png' alt=''></a>
						 </li>
						 <li class='btn_prev'><a class='no_next' href='#".$pageNum."'>
						 <img src='/images/i_prev.png' alt=''></a>
						 </li>";
				}else{
					$page_html.="
						 <li class='btn_prev'>
				...
				if($block<$total_block){
					$page_html.="
							...
							<img src='/images/i_next.png' alt=''></a>
							</li>
							<li class='btn_next'><a href='javascript:".$fn."($total_page);'>
							<img src='/images/i_double_next.png' alt=''></a>
							</li>
					";
					...
					$page_html.="
							<li class='btn_next'><a class='no_next' href='javascript:".$fn."($total_page);'>
							<img src='/images/i_next.png' alt=''></a>
							</li>
							<li class='btn_next'><a href='javascript:".$fn."($total_page);'>
							<img src='/images/i_double_next.png' alt=''></a>
...
//faq type 별 title 가져오기
    ...
    $res = "";
    $lang = !empty($_REQUEST['lang'])?$_REQUEST['lang']:'kr';
